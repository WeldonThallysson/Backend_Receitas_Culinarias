...
E para o banco de dados local mantenha apenas
```env
DATABASE_URL="sua url" #Local
DATABASE_USER="seu user"
...
Para o banco de dados em homologação é necessário pegar da referência homolog ou railway
---
